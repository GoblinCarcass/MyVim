...
map("n", "<Leader>wq", ":w<CR>:q<CR>", { desc = "Write, then Quit" })
...
map("n", "<Leader>fg", builtin.live_grep, { desc = "Telescope - Live search for a keyword in your current working directory" })
map("n", "<Leader>fd", builtin.current_buffer_fuzzy_find, { desc = "Telescope - Live search for a keyword in a current buffer" })
map("n", "<Leader>fz", builtin.git_files, { desc = "Telescope - Fuzzy find through git commits" })

-- Buffer Manager
local buf_man = require("buffer_manager.ui")
map("n", "<Leader>fb", buf_man.toggle_quick_menu, { desc = "Live search through all of your opened buffers" })
map("n", "<C-j>", buf_man.nav_next, { desc = "Live search through all of your opened buffers" })
map("n", "<C-k>", buf_man.nav_prev, { desc = "Live search through all of your opened buffers" })
...
map("n", "<Leader>rn", vim.lsp.buf.rename, { desc = "Rename all references to the symbol under the cursor e.g. variable name." })
